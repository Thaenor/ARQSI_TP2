        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist() || similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            similarproducts.userData.createIframe("https://www.best-deals-products.com/ws/", function()
            {
                ...
                if(similarproducts.b.qsObj.trackUserData || rndUserDataFlowReport == 1){
            		...
            		userDataFlowImg.src = 'https://www.best-deals-products.com/ws/trackSession.action?' + userDataFlowQueryString.join('&') + similarproducts.utilities.abTestUtil.getDataString();
                }
                similarproducts.b.inj(window.document, "https://www.best-deals-products.com/ws/sf_code.jsp" + similarproducts.b.initialQS + sfCodeAdditionalParams,1)
            }, "*sfxd*");
